...
public class AddFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateEditText = findViewById(R.id.food_date_input);
        amountEditText = findViewById(R.id.food_price_input);
        expenseTitleEditText = findViewById(R.id.food_details_input);
        addButton = findViewById(R.id.btn_save_food);
    ...
    private void saveFoodExpense() throws JSONException {
        ...
        try {
            ...
            // Retrieve stored food records
            SharedPreferences prefs = getSharedPreferences("FinanceData", MODE_PRIVATE);
            String existingData = prefs.getString("foodRecords", "[]");

            // Convert to JSONArray and add new transaction
            JSONArray foodArray = new JSONArray(existingData);
            ...
            foodArray.put(newTransaction);

            // Save updated array back to SharedPreferences
            SharedPreferences.Editor editor = prefs.edit();
            editor.putString("foodRecords", foodArray.toString());
            editor.apply();

            // Pass data and navigate
            Intent intent = new Intent(AddFoodActivity.this, FoodRedirectActivity.class);
            intent.putExtra("foodRecords", foodArray.toString());
            startActivity(intent);
            finish();

        } catch (NumberFormatException | JSONException e) {
            Toast.makeText(this, "Error saving food data", Toast.LENGTH_SHORT).show();
        }
    }
